...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Kisii to Rongo","Rodi to Awendo","Luanda to Kisumu","Webuye to Kitale","Narok to Nairobi","Machakos to Mombasa"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
void bus() // for displaying a list of available bus routes
{
    system("cls");
    printf("\n\n\n");
    printf(" BUS RESERVATION SYSTEM \n\n\n");
...
void booking() //for booking bus tickets
{
...
printf("\n\t\t\t\tSEAT BOOKED The Total booking amount is %d",10*booking);
itoa(seat1, str1, 10);
...
void name_number(int booking,char numstr[100]) // for storing passenger names and booking numbers
{
...
void read_name(int trno) // for reading booking numbers from a file
{
...
void status() // for printing the status of booked and available seats based on user input
{
system("cls");
printf(" BUS RESERVATION SYSTEM \n\n\n");
...
void cancle() //function for cancelling tickets
{
 int seat_no,i,j;
...
printf("\n\n");
    printf("======================================================================================================\n");
 printf("\t\t\t\tYour 10$ has been Returned\t\t\t\n");
    printf("======================================================================================================\n");
}
    ...
    do
{
	...
	i=0;
		...
		if(strcmp(uname,"goshen")==0 && strcmp(pword,"goshen")==0)
	{
	printf("  \n\n\n       LOGIN IS SUCCESSFUL");  
